...
export default function LoginPage({ onEnterApp }) {
        ...
        <div style={s.outer}>
          ...
          <div style={{ ...s.card, textAlign: "center" }}>
            <div style={{ border: "1px solid rgba(74,175,122,0.4)", background: "var(--card)", padding: 40 }}>
              ...
              <p style={{ fontSize: 10, letterSpacing: "0.15em", color: "var(--chart-2)", textTransform: "uppercase", marginBottom: 8 }}>Authentication successful</p>
      ...
      <div style={s.outer}>
        ...
        <div style={s.card}>
          <div style={s.headerBlock}>
            <div style={{ display: "flex", alignItems: "center", gap: 12, marginBottom: 14 }}>
              ...
              <div style={{ flex: 1 }}>
                ...
                <p style={{ fontSize: 11, fontWeight: 700, color: "var(--primary)", textTransform: "uppercase", letterSpacing: "0.15em", textShadow: "0 0 10px var(--primary-glow)" }}>SIGN_IN.exe</p>
              </div>
            ...
            <div style={{ borderTop: "1px dashed var(--border)", paddingTop: 12 }}>
              <p style={{ fontSize: 10, color: "var(--fg-dim)", lineHeight: 1.7 }}>Enter credentials to access the cognitive platform.</p>
            </div>
          </div>
          ...
          <div style={s.body}>
            ...
            >
              {loading ? `Authenticating${dots}` : <><ArrowRight size={14} /> Access Terminal</>}
            </button>
          </div>

          <div style={s.footer}>
            <span style={{ fontSize: 9, color: "var(--fg-dim)", letterSpacing: "0.08em" }}>No account?</span>
            <button style={{ background: "none", border: "none", fontSize: 9, letterSpacing: "0.15em", textTransform: "uppercase", color: "rgba(200,136,42,0.7)", cursor: "pointer", fontFamily: "inherit", display: "flex", alignItems: "center", gap: 4 }} onClick={() => navigate("/register")}>
