      ...
      <div style={s.outer}>
        ...
        <div style={s.card}>
          ...
          <div style={s.footer}>
            ...
            <button style={{ background: "none", border: "none", fontSize: 9, letterSpacing: "0.15em", textTransform: "uppercase", color: "rgba(200,136,42,0.7)", cursor: "pointer", fontFamily: "inherit" }} onClick={() => navigate("/register")}>
